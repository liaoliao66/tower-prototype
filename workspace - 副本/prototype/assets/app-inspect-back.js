...
(function () {
  ...
  var MODULE_BY_FILE = {
    ...
    'app_inspect_feed.html': { id: 'feed', name: '馈线' },
  ...
  function injectModuleToolbar() {
    ...
    var useFooterActions =
      !!footer && footer.getAttribute('data-inspect-module-actions') !== '1';
    ...
    var memoRel = taskRelPrefix() + '/备忘录/app_task_memo.html';
    var memo = null;
    if (!skipMemoToolbar(mod)) {
